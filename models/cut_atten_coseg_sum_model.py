...
from .patchnce import PatchNCELoss, SupPatchNCELoss, AttenPatchNCELoss
import util.util as util
from loss_functions.dice_loss import SoftDiceLoss
from loss_functions.nt_xent import NTXentLoss


class CUTAttenCosegSumModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            for nce_layer in self.nce_layers:
                self.criterionNCE.append(AttenPatchNCELoss(opt).to(self.device))
