...
class CUTCosegModel(BaseModel):
    ...
    def backward_S(self):
        ...
        self.loss_fake_ce = self.criterionCE(self.fake_seg_B, self.real_A_label.squeeze(1))
        ...
        self.loss_S_B = self.loss_fake_S + self.loss_D_S  # + F.cross_entropy(self.fake_seg_B, self.real_A_label.squeeze(1))
