...
class CUTSupSegModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netS_B = networks.define_G(opt.input_nc, opt.num_classes, opt.ngf, opt.netG, opt.normG, not opt.no_dropout,
                                      opt.init_type, opt.init_gain, opt.no_antialias, opt.no_antialias_up,
                                      self.gpu_ids, opt)
