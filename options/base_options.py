...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--fold', type=int, default=1, help='choose the cross validation fold number')
        parser.add_argument('--src_dir', type=str, default='../data/mmwhs/ct', help='directory of source domain data')
        parser.add_argument('--target_dir', type=str, default='../data/mmwhs/mri',
                            help='directory of target domain data')
        parser.add_argument('--src_data_dir', type=str, default='./data/abdominal_data/chaos/cropped',
                            help='directory of target domain data')
        parser.add_argument('--target_data_dir', type=str, default='./data/abdominal_data/chaos/cropped',
                            help='directory of target domain data')
        parser.add_argument('--num_classes', type=int, default=8, help='number of classes to be classified')
        ...
        parser.add_argument('--netS', type=str, default='con_unet',
                            choices=['resnet', 'con_unet'], help='specify generator architecture')
