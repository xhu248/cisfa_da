...
if __name__ == '__main__':
    ...
    train_data_loader, test_data_loader = create_dataset(opt)  # create a dataset given opt.dataset_mode and other options
    dataset_size = len(train_data_loader)    # get the number of images in the dataset.
    ...
    writter = SummaryWriter(visualizer.save_dir)
    model.save_dir = visualizer.save_dir
        ...
        for i, data in enumerate(train_data_loader):  # inner loop within one epoch
            ...
            if total_iters % opt.print_freq == 0:    # print training losses and save logging information to the disk
                ...
                if epoch > opt.seg_start_point:
                    if losses['fake_S'] < min_seg_loss:
                        model.save_networks('best')
                        min_seg_loss = losses['fake_S']
